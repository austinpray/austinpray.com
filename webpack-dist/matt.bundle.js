	...
	var states = {
	  ...
	  eyesOpen: function eyesOpen() {
	    ...
	    (0, _delay2.default)(function () {
	      return sendMessage(HELP_PS1, "You can `inspect` things. You can also `stand up`. You can check your `pockets` as well.");
	    }, 3000);
	  ...
	  gameRoomStandUp: function gameRoomStandUp() {
	    ...
	    sendMessages(MESSAGE_PS1, "You are definitely spooked. You can't remember how you got inside Matt's old house. " + "You can't remember ", "You stand up to inspect the rest of the room.", "Behind Matt you see a door than you know leads to the balcony.");
	    return (0, _extends3.default)({}, state, {
