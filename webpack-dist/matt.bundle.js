...
/***/ function(module, exports, __webpack_require__) {
	...
	var _curry = __webpack_require__(61);
	...
	var MESSAGE_PS1 = (0, _symbol2.default)("message ps1");
	var HELP_PS1 = (0, _symbol2.default)("help ps1");
	var USER_PS1 = (0, _symbol2.default)("user ps1");

	var termPS1 = function termPS1(type) {
	...
	var sendMessage = (0, _curry2.default)(function (ps1, message) {
	  var messageEl = document.createElement('div');
	  messageEl.className = "message " + (ps1 === USER_PS1 && "message-user");

	  var messageText = document.createElement("div");
	  messageText.className = "message-text";
	  messageText.innerHTML = (0, _marked2.default)(message);
	...
	var sendInfoMessage = sendMessage(MESSAGE_PS1);
	var sendHelpMessage = sendMessage(HELP_PS1);

	var sendMessages = function sendMessages(ps1) {
	...
	var sendImage = function sendImage(path) {
	  var img = new Image();
	  img.src = path;
	  var messageEl = document.createElement('div');
	...
	var contains = function contains(input) {
	  for (var _len2 = arguments.length, targets = Array(_len2 > 1 ? _len2 - 1 : 0), _key2 = 1; _key2 < _len2; _key2++) {
	    targets[_key2 - 1] = arguments[_key2];
	  }

	  return (0, _some2.default)(targets, function (target) {
	    return input.toLowerCase().indexOf(target.toLowerCase()) > -1;
	  });
	};

	var handlerMiddleware = function handlerMiddleware(input, state) {
	  if (contains(input, "who am") || contains(input, "what", "my name")) {
	...
	var states = {
	  ...
	  eyesOpen: function eyesOpen() {
	    ...
	    var lookAround = function lookAround() {
	      sendMessages(MESSAGE_PS1, "You are in familiar place. Matt's old game room. The old Quanah Drive house in Round Rock. You are sitting on the couch.", "The game room is exactly as you remember it.", "Straight ahead of you is a _TV_ blaring Super Smash Brothers Melee. The TV is flanked on both sides by large bookshelves. " + "You look to the right of the bookshelf and you see Matt's _totem pole_. The _gamecube_ is on the ground. " + "A DVD player on the bookshelf has a _clock_ on it.", "You look over to the right: _Matt_ is sitting in the love seat hammering away at a gamecube controller. His eyes are transfixed on the screen.", "You glance left: _Brittany_ is sitting in the other loveseat on the other side of the room. She is clumsily mashing buttons on the controller, but is having fun regardless.", "You feel around in your pockets but can't feel a phone or anything. Your pockets are empty.", "", "You feel uneasy. Didn't Matt's parents sell their Round Rock house years ago? This is not making sense at all.");
	    };
	      ...
	      handle: function handle(input) {
	        ...
	        if (contains(input, "inspect", "look")) {
	          ...
	          if (contains(input, "totem")) {
	            ...
	            return sendInfoMessage("On top of the totem pole is an eagle. Didn't Matt take this with him to San Marcos when he moved out?");
	          }
	          ...
	          if (contains(input, "matt")) {
	            ...
	            return sendMessage(MESSAGE_PS1, "Matt is wrecking brittany at smash. " + "He's wearing a yellow shirt and jeans. " + "He looks much younger than the last time you saw him. " + "Well that's weird.");
	          }
	  ...
	  balcony: function balcony(state) {
	  ...
	  mattEverythingAlrightQuestion: function mattEverythingAlrightQuestion(state) {
	  ...
	  bathroom: function bathroom(state) {
	      ...
	      handle: function handle(input) {
	        ...
	        if (contains(input, "mirror")) {
	          ...
	          if (!state.freakingOut) {
	            ...
	            return states.hallway((0, _extends3.default)({}, state, {
	              seenSelf: true
	            }));
	          }
	        }
	  ...
	  mattsRoom: function mattsRoom(state) {
	  ...
	  searchPack: function searchPack(state) {
	    ...
	    state.wallet = true;
	    state.knowYear = true;
	    var knewDay = state.knowDay;
	    state.knowDay = true;
	    return (0, _extends3.default)({}, state, {
	      handle: function handle(input) {
	        if (contains(input, "phone")) {
	          sendInfoMessage("It's really funny. Your phone actually confirms what is going on more than anything. " + "You know for a fact that the iPhone 4 came out in 2010. And you know for a fact that you ditched " + "that stupid BMF wallet shortly after getting the iPhone 4. So it is definitely 2010.");
	        ...
	        if (contains(input, "wallet")) {
	          ...
	          sendInfoMessage("Has some cash. No credit card. No cards from Wells Fargo. " + "A+ Federal Credit Union Debit card that expires 08/2012");
	        }
	  ...
	  returnToGameRoom: function returnToGameRoom(state) {
	...
	form.addEventListener('submit', function (e) {
	  ...
	  var newState = handlerMiddleware(input, state);
	  if (newState) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createWrap = __webpack_require__(62);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseSetData = __webpack_require__(63),
	    createBind = __webpack_require__(77),
	    createCurry = __webpack_require__(80),
	    createHybrid = __webpack_require__(82),
	    createPartial = __webpack_require__(120),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createCtor = __webpack_require__(78),
	    root = __webpack_require__(73);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var apply = __webpack_require__(81),
	    createCtor = __webpack_require__(78),
	    createHybrid = __webpack_require__(82),
	    createRecurry = __webpack_require__(86),
	    getHolder = __webpack_require__(116),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var composeArgs = __webpack_require__(83),
	    ...
	    countHolders = __webpack_require__(85),
	    createCtor = __webpack_require__(78),
	    createRecurry = __webpack_require__(86),
	    getHolder = __webpack_require__(116),
	    reorder = __webpack_require__(117),
	    replaceHolders = __webpack_require__(119),
	    root = __webpack_require__(73);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isLaziable = __webpack_require__(87),
	    setData = __webpack_require__(100),
	    setWrapToString = __webpack_require__(102);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LazyWrapper = __webpack_require__(88),
	    getData = __webpack_require__(90),
	    getFuncName = __webpack_require__(92),
	    lodash = __webpack_require__(94);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var realNames = __webpack_require__(93);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LazyWrapper = __webpack_require__(88),
	    LodashWrapper = __webpack_require__(95),
	    baseLodash = __webpack_require__(89),
	    isArray = __webpack_require__(96),
	    isObjectLike = __webpack_require__(97),
	    wrapperClone = __webpack_require__(98);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getWrapDetails = __webpack_require__(103),
	    insertWrapDetails = __webpack_require__(104),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var constant = __webpack_require__(107),
	    ...
	    nativeDefineProperty = __webpack_require__(108);
