...
(function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){
    ...
    ga('create', 'UA-4694964-14', 'austinpray.com');
    ga('send', 'pageview');
...
-->
                ...
                <section class="sixteen columns">
                    ...
                    <div class="row features">
                        <section class="alpha one-third column">
                            <figure class="picto cate">&#230;QO</figure>

                            <p class="lead">perfectly adapts content to any screen size, retina optimized</p>
                        </section>

                        <section class=" one-third column">
                            <figure class="picto cate">S</figure>

                            <p class="lead">custom full browser product introduction</p>
                        </section>
    ...
    <section class="oven-mitt" id="skills">
        <article class="container">
            <div class="row">
                <section class="sixteen columns">
                    <figure class="picto header-icon">(</figure>
...
==================================================
Made with love by Austin Pray  | (• ◡•)| (❍ᴥ❍ʋ)
 -->
</body>
</html>
